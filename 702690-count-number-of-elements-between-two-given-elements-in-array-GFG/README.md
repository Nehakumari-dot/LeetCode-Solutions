# [Count number of elements between two given elements in array](https://www.geeksforgeeks.org/problems/count-number-of-elements-between-two-given-elements-in-array4044/1?utm_medium=ml_article_practice_tab&utm_campaign=article_practice_tab&utm_source=geeksforgeeks)
## Easy
...
Output: 1Explanation: here in array [3, 2, 1, 4] only one element [1] occur betweeen 2 and 4, So, answer is 1.

Expected Time Complexity: O(n).Expected Auxiliary Space:&nbsp;O(1).
Constraints:2 ≤ arr.size() ≤ 1061 ≤ arr[i], num1, num2 ≤ 106